...
#include "vulkan/initialization-functions/create-synchronous-objects.hpp"
...
#include "vulkan/initialization-functions/create-command-buffers.hpp"
...
#include "vulkan/initialization-functions/create-depth-resources.hpp"
